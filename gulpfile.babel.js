...
import { forEach } from "./src/templates/data/helpers/index";
import data from "./src/templates/data/index";
...
gulp.task("hbs-dev", () => {
  let options = {
    ...
    batch: ["src/templates/includes"],
    helpers: {
      forEach
    } // Javascript array of filepaths to use as partials
  };
...
gulp.task(
  "dev",
  ["styles-dev", "hbs-dev", "scripts-dev", "images-dev"],
  () => {
    server.init({
      server: {
        baseDir: "./public"
